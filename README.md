...
## V
- Project name (human): ⟨Project Nam
- One-liner (en/fa): ⟨One-liner EN⟩ /
- Problem this solves (1–2 sentences): ⟨
- Primary stack: ⟨Node.js@20 + TypeScript⟩ (or: Python3.12 / Go / Next.js / React / FastAPI / 
 Package manager: ⟨pnpm⟩ (o
- License: ⟨MIT
- Docker: ⟨
- DB (optional): ⟨none / SQLite / Post
- Testing: ⟨Vitest + Cove
